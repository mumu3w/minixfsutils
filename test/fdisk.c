...
inline uint8 read_sect(uint16 sect_cyl)
{
    return sect_cyl & 0x3f;
}

inline uint16 read_cyl(uint16 sect_cyl)
{
    return ((sect_cyl << 2) & 0x0300) | ((sect_cyl >> 8) & 0xff);
}

inline uint16 set_sect(uint16 sect_cyl, uint8 sector)
{
...
inline uint16 set_cyl(uint16 sect_cyl, uint16 cyl)
{
